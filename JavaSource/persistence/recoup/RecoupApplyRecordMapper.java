...
public interface RecoupApplyRecordMapper {
	 ...
	 * to the database table recoup_apply_record
	 * 
	 ...
	 * @version V1.0
	 */
	List<RecoupApplyRecordExtend> selectRecoupListBy(
			@Param("projectCode") String projectCode,
			@Param("payState") Integer payState,
			@Param("applyDateStart") Date applyDateStart,
			@Param("applyDateEnd") Date applyDateEnd);
}