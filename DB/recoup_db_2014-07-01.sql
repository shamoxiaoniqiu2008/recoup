...
CREATE TABLE `recoup_apply_record` (
  ...
  `proj_name` varchar(90) NOT NULL COMMENT '项目名称',
...
-- ----------------------------
--  Records of `recoup_dic_costclass1`
-- ----------------------------
BEGIN;
INSERT INTO `recoup_dic_costclass1` VALUES ('1', 'fy001', '日常费用', 'rcfy', null, '2'), ('2', 'fy002', '临时费用', 'lsfy', null, '2');
COMMIT;
...
-- ----------------------------
--  Records of `recoup_dic_costclass2`
-- ----------------------------
BEGIN;
INSERT INTO `recoup_dic_costclass2` VALUES ('1', '1', 'fy001', 'fy001001', '交通补助', null, '2'), ('2', '2', 'fy002', 'fy002001', '加班打车', null, '2');
COMMIT;
...
-- ----------------------------
--  Records of `recoup_dic_payclass`
-- ----------------------------
BEGIN;
INSERT INTO `recoup_dic_payclass` VALUES ('1', '刷卡', 'sk', null, '2', '2'), ('2', '现金', 'xj', null, '2', '1');
COMMIT;
